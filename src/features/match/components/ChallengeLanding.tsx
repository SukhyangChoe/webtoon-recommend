...
export function ChallengeLanding({ challengeCode }: { challengeCode: string }) {
  ...
  function submit(event: React.FormEvent) {
    ...
    if (existingResultId) continueWithExisting();
    else startFresh();
  }
