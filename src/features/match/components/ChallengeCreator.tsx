...
export function ChallengeCreator() {
  ...
  async function copyLink() {
    if (!created) return;
    try {
      await navigator.clipboard.writeText(created.challengeUrl);
