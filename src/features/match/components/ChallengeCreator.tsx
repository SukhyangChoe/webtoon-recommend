...
function ReciprocalRankingGuide() {
  return <aside className="match-reciprocal-guide"><strong>서로의 랭킹에 이어져요</strong><p>상대가 이 링크로 궁합을 본 뒤 자기 링크를 만들면, 내 결과도 상대 랭킹에 자동으로 표시돼요.</p></aside>;
}
